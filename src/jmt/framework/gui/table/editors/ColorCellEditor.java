...
public class ColorCellEditor extends AbstractCellEditor
                         implements TableCellEditor, CellEditor,
                                    ActionListener, TableCellRenderer {
    ...
    public void actionPerformed(ActionEvent e) {
        if (EDIT.equals(e.getActionCommand())) {
            ...
            JDialog dialog = JColorChooser.createDialog(button,
                                            "Choose User Class Color",
                                            true,  //modal
                                            colorChooser,
                                            this,  //OK button handler
                                            null); //no CANCEL button handler
            Dimension scrDim = Toolkit.getDefaultToolkit().getScreenSize();
            dialog.setBounds((scrDim.width-dialog.getWidth())/2,
                    (scrDim.height-dialog.getHeight())/2,
