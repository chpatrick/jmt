...
//	    intZeros = new int[cls];
    ...
    public boolean input(String[] n, int[] t, double[][][] s, double[][] v, int[] pop) {
        ...
        if ((n.length != stations) || (t.length != stations) ||
                (s.length != stations) || (v.length != stations))
...
//            printStatus();
    ...
    public static void testLI() {
        ...
        if ((Math.abs(2.667 - solver.getThroughput(0, 0)) >= 0.001) ||
                (Math.abs(1.794 - solver.getThroughput(0, 1)) >= 0.001) ||
                (Math.abs(4.576 - solver.getThroughput(0, 2)) >= 0.001) ||
                (Math.abs(0.320 - solver.getThroughput(1, 0)) >= 0.001) ||
                (Math.abs(2.421 - solver.getThroughput(1, 1)) >= 0.001) ||
                (Math.abs(0.558 - solver.getThroughput(1, 2)) >= 0.001) ||
                (Math.abs(1.067 - solver.getThroughput(2, 0)) >= 0.001) ||
                (Math.abs(1.794 - solver.getThroughput(2, 1)) >= 0.001) ||
                (Math.abs(0.448 - solver.getThroughput(2, 2)) >= 0.001) ||
                (Math.abs(2.294 - solver.getThroughput(3, 0)) >= 0.001) ||
                (Math.abs(1.136 - solver.getThroughput(3, 1)) >= 0.001) ||
                (Math.abs(0.137 - solver.getThroughput(3, 2)) >= 0.001) ||
                (Math.abs(0.133 - solver.getUtilization(0, 0)) >= 0.001) ||
                (Math.abs(0.179 - solver.getUtilization(0, 1)) >= 0.001) ||
                (Math.abs(0.686 - solver.getUtilization(0, 2)) >= 0.001) ||
                (Math.abs(0.032 - solver.getUtilization(1, 0)) >= 0.001) ||
                (Math.abs(0.484 - solver.getUtilization(1, 1)) >= 0.001) ||
                (Math.abs(0.167 - solver.getUtilization(1, 2)) >= 0.001) ||
                (Math.abs(0.160 - solver.getUtilization(2, 0)) >= 0.001) ||
                (Math.abs(0.538 - solver.getUtilization(2, 1)) >= 0.001) ||
                (Math.abs(0.201 - solver.getUtilization(2, 2)) >= 0.001) ||
                (Math.abs(0.458 - solver.getUtilization(3, 0)) >= 0.001) ||
                (Math.abs(0.454 - solver.getUtilization(3, 1)) >= 0.001) ||
                (Math.abs(0.082 - solver.getUtilization(3, 2)) >= 0.001))
            System.out.println("\nTest failed");
        else
            System.out.println("\nTest succeded");
    }
