...
import jmt.gui.common.xml.GuiXMLConstants;
...
public class PAResultsModel implements MeasureDefinition{
    ...
    public void addMeasure(String name, String stationName, String className,
                       double alpha, double precision, int type, String measureType) {
    ...
    protected class Measure {
        ...
        public Measure(String name, String stationName, String className,
                       double alpha, double precision, int type, String nodeType) {
            this.name = name;
