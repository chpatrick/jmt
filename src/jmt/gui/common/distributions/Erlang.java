...
public class Erlang extends Distribution {
    ...
    protected void setCM(double mean, double c) {
        ...
        if (getParameter("r").setValue(new Double(1/(c * c))) &&
                getParameter("alpha").setValue(new Double(1/(c * c * mean)))) {
            this.mean = mean;
            this.c = c;
        }
        else {
    ...
    public void updateCM() {
        mean = ((Double)getParameter("r").getValue()).doubleValue() /
