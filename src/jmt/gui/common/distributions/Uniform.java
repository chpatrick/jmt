...
public class Uniform extends Distribution{
    ...
    public Uniform() {
        ...
        this.setValueChecker(new ValueChecker() {
            public boolean checkValue(Object value) {
                ...
                if (((Double)d.getParameter("min").getValue()).doubleValue() <
                        ((Double)d.getParameter("max").getValue()).doubleValue())
                    return true;
                else
                    return false;
            }
    ...
    protected Distribution.Parameter[] setParameters() {
        ...
        // Sets parameter min
        parameters[0] = new Distribution.Parameter("min",
                "min",
                Double.class,
                new Double(0));
        ...
        // Sets parameter max
        parameters[1] = new Distribution.Parameter("max",
                "max",
                Double.class,
                new Double(1));
    ...
    protected void setCM(double mean, double c) {
        ...
        if (getParameter("max").setValue(new Double(max)) &&
                getParameter("min").setValue(new Double(min))) {
            this.mean = mean;
            this.c = c;
        }
        else {
