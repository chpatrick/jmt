...
public class RoutingBulletPre_Test extends JFrame{
    ...
    private void prepareQueueNet(){
        ...
        Point[] link05ps={new Point(260,115),new Point(280,115), new Point(280,140), new Point(10,140), new Point(10,115), new Point(30,115)};
        ...
        qnAni.addJob(new JobAnimation(0.1,
                                    new JobPath[]{new RandomPath(qnAni, station1)},
                                    new Rectangle(10,10))
                , station1);
    }
