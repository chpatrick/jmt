...
public class ServiceSectionPanel extends WizardPanel implements CommonConstants {
                ...
                if(index>=0 && index<serviceTable.getRowCount()) {
                    ...
                    if (service instanceof Distribution) {
                        DistributionsEditor editor = DistributionsEditor.getInstance(
                                ServiceSectionPanel.this.getParent(),
                    ...
                    // Otherwise shows LDStrategy Editor
                            ...
                            LDStrategyEditor editor = LDStrategyEditor.getInstance(
                                    ServiceSectionPanel.this.getParent(),
                                    (LDStrategy)service);
                            // Sets editor window title
    ...
    private void updateSpinner(){
        serversNumSpinner.setValue(
                data.getStationNumberOfServers(stationKey));
        ...
        else serversNumSpinner.setEnabled(true);
    }
    ...
    public void repaint(){
        if(serviceTable!=null)serviceTable.tableChanged(new TableModelEvent(serviceTable.getModel()));
        super.repaint();
    }
    ...
    protected class ServiceTable extends JTable{
        ...
        protected Object[] serviceType =
                new Object[] {SERVICE_LOAD_INDEPENDENT, SERVICE_LOAD_DEPENDENT, SERVICE_ZERO};
    ...
    protected class ServiceTableModel extends AbstractTableModel{
        ...
        private Class[] columnClasses = new Class[]{
            String.class, JComboBox.class, String.class, Object.class
        };
