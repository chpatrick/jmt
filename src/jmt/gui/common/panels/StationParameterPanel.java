...
public class StationParameterPanel extends WizardPanel implements CommonConstants {
    ...
    public void setData(Object stationKey){
        ...
        }else title.setTitle("Parameters Definition");
    ...
    private boolean hasServiceSection(String type){
        if(checkNullValues()) return false;
            ...
            return STATION_TYPE_SERVER.equals(type)||
                    STATION_TYPE_DELAY.equals(type);
        }
    }
    ...
    private boolean hasRoutingSection(String type){
        if(checkNullValues()) return false;
            ...
            return STATION_TYPE_SERVER.equals(type)||
                    STATION_TYPE_DELAY.equals(type)||
                    STATION_TYPE_SOURCE.equals(type)||
                    STATION_TYPE_ROUTER.equals(type)||
                    STATION_TYPE_TERMINAL.equals(type) ||
