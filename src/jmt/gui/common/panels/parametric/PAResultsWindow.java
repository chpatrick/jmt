...
public class PAResultsWindow extends JMTFrame implements ResultsConstants,ParametricAnalysis {
    ...
    private void initGUI() {
     ...
     public String getXLabel() {
        if (pad instanceof NumberOfCustomerParametricAnalysis)
            ...
            else return "Ratio between assumed arrival rate and the initial one [%]";
        }
            ...
            else return "Ratio between assumed service time at " + stpa.getReferenceStationName() + " and the initial one [%]";
        }
    ...
    public String getYLabel(int measureIndex) {
        ...
        if ( (measureType == SimConstants.QUEUE_LENGTH) || (measureType == SimConstants.SYSTEM_JOB_NUMBER))
            subfix = " (j)";
        else if ((measureType == SimConstants.QUEUE_TIME) || (measureType == SimConstants.RESIDENCE_TIME) || (measureType == SimConstants.RESPONSE_TIME) || (measureType == SimConstants.SYSTEM_RESPONSE_TIME))
            subfix = " (s)";
    ...
    protected class PAMeasurePanel extends JPanel implements PlotContainer{
        ...
        protected void createPanel() {
            ...
            if (XMAX > SPINNER_PRECISION) xMin = new JSpinner(new SpinnerNumberModel(XMIN,0,XMAX-SPINNER_PRECISION,SPINNER_PRECISION));
            else xMin = new JSpinner(new SpinnerNumberModel(XMIN,0,XMAX,SPINNER_PRECISION));
            ...
            if (YMAX - SPINNER_PRECISION > YMIN) yMin = new JSpinner(new SpinnerNumberModel(YMIN,0,YMAX-SPINNER_PRECISION,SPINNER_PRECISION));
            else yMin = new JSpinner(new SpinnerNumberModel(YMIN,0,YMAX,SPINNER_PRECISION));
            ...
            if (YMIN + SPINNER_PRECISION < YMAX) yMax = new JSpinner(new SpinnerNumberModel(YMAX,YMIN+SPINNER_PRECISION,YMAX,SPINNER_PRECISION));
            else yMax = new JSpinner(new SpinnerNumberModel(YMAX,YMIN,YMAX,SPINNER_PRECISION));
    ...
    protected class ValuesTableModel extends ExactTableModel  {
        ...
        private String getFormattedVal(double value) {
            ...
            else return threeDecFormat.format(value);
        }
        ...
        */
        protected Object getRowName(int rowIndex) {
            ...
            if ( (measureType == SimConstants.QUEUE_LENGTH) || (measureType == SimConstants.SYSTEM_JOB_NUMBER))
                ...
                subfix = " ";
            if (rowIndex == 0) return ("Mean value" + subfix);
            else if (rowIndex == 1) return ("Max" + subfix) ;
            else return ("Min" + subfix);
        }
