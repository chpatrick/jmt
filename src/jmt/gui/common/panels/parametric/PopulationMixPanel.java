...
public class PopulationMixPanel extends ParameterOptionPanel {
    ...
    public PopulationMixPanel(PopulationMixParametricAnalysis pmpa, ClassDefinition classDef, StationDefinition stationDef, SimulationDefinition simDef) {
        ...
        DESCRIPTION ="This type of analysis is available for closed models with two classes only " +
                ...
                "population mix (ßi = Ni / N) for the chosen class.\n\n" +
    ...
    public void initialize() {
        ...
        if (maxSteps > ParametricAnalysis.MAX_STEP_NUMBER)  maxSteps = ParametricAnalysis.MAX_STEP_NUMBER;
    ...
    private void setListeners() {
        from.addChangeListener(new ChangeListener() {
            public void stateChanged (ChangeEvent e) {
                if (from.getValue() instanceof Double) {
                    ...
                    if (newMaxSteps > ParametricAnalysis.MAX_STEP_NUMBER)  newMaxSteps = ParametricAnalysis.MAX_STEP_NUMBER;
                    ...
                    else PMPA.setInitialValue(oldValue);
                }
        ...
        to.addChangeListener(new ChangeListener() {
            public void stateChanged (ChangeEvent e) {
                    ...
                    else PMPA.setFinalValue(oldValue);
                }
