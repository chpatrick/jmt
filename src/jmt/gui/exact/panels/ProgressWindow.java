    ...
    private void initGUI() {
        ...
        if (iterations > 1)
            mainLabel = new JLabel(CommonConstants.HTML_START + CommonConstants.HTML_FONT_TITLE +
                    PAProgressWindow.RUNNING_MESSAGE + CommonConstants.HTML_FONT_TIT_END +
                    CommonConstants.HTML_END);
        else
            mainLabel = new JLabel(CommonConstants.HTML_START + CommonConstants.HTML_FONT_TITLE +
                    "JMVA is solving current model, please wait..." + CommonConstants.HTML_FONT_TIT_END +
                    CommonConstants.HTML_END);
            ...
            synchronized(this) {
                while (!killed) {
                    try {
                        ...
                        elapsedTimeLabel.setText("Elapsed time: " + formatter.format(elapsedTime /60000) +
                                "m : "+ formatter.format(((elapsedTime /1000)%60)) + "s");
                        this.wait(1000);
