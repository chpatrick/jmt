...
public interface ExactConstants {
    ...
    */
    //NEW
    public static final String[] STATION_TYPENAMES = {"Delay (Infinite Server)",
                                                      "Load Independent",
                                                      GRAY_S + "Load Dependent" + GRAY_E};
    ...
    public static final String DESCRIPTION_WHATIF_NONE = "<html><body align=\"left\"><font size=\"4\"><b>What-if analysis</b>"+
                ...
                "changing in the selected range. " +
                "The performance indices will be shown " +
                "in a graph. </font></body></html>";
    public static final String DESCRIPTION_WHATIF_ARRIVAL_ALL = "<html><body align=\"left\"><font size=\"4\"><b>What-if analysis</b>"+
                ...
                "Starting from the actual value, the arrival rates are increased (or decreased) " +
    ...
    public static final String DESCRIPTION_WHATIF_CUSTOMERS_ALL = "<html><body align=\"left\"><font size=\"4\"><b>What-if analysis</b>"+
                ...
                "Starting from the actual value, the population is increased (or decreased) " +
                "by the percentage expressed in the 'to' value.<br>" +
                "Since only integer population values are allowed, the number of models executed can be very small." +
                "</font></body></html>";
