...
public class ExactWizard extends Wizard {
    ...
    private void showHelp(ActionEvent event){
        ...
        */
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(this, "Sorry, jMVA help is not available",
   ...
   public HelpSet getHelpSet(String helpsetfile) {
    ...
    private void createSolutionWindow(){
        ...
        solutionWindow.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        ...
        if(tempFile!=null)synPane = new SynopsisPanel(this, tempFile);
        else synPane = new SynopsisPanel(this);
        jtp.add(synPane);
        //END
