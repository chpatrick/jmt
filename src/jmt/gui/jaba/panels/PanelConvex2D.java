	...
	public class PanelConvex2D extends JPanel implements MouseListener, MouseMotionListener {
	    ...
	    public void mousePressed(MouseEvent e) 
	    {
	    	...
	    	if(e.getButton()==1){
	    		...
	    		if(selPoint){setCursor(Cursor.getPredefinedCursor(Cursor.CROSSHAIR_CURSOR)); }
	    		editFigura=true;
	    	}
	    }
	    ...
	    public void mouseReleased(MouseEvent e) 
	    {
	    	...
	    	if(!selPoint&&dragging){
	    		if(mouseButtonPress==1){
	    			mouseButtonPress=0;
	    			engine.addFilterArea(painter.getTrueX(dPoint.getX()), painter.getTrueY(dPoint.getY()), painter.getTrueX(bPoint.getX()), painter.getTrueY(bPoint.getY()),((painter.getPointSize()/painter.getScale())/2));
	    			editFigura=true;
	    			repaint();
	    		}
	    		...
	    		{
	    			mouseButtonPress=0;
	    			engine.addFreeArea(painter.getTrueX(dPoint.getX()), painter.getTrueY(dPoint.getY()), painter.getTrueX(bPoint.getX()), painter.getTrueY(bPoint.getY()),((painter.getPointSize()/painter.getScale())/2));
	    			editFigura=true;
	    			repaint();
	    		}
	    	}
