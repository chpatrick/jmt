...
public class JabaModel implements JabaConstants {
            ...
            for(int i=0; i<retVal.length; i++){
                ...
                for(int j=0; j<throughput.length; j++){
                    ...
                    if(visits[j][i]!=0){
                        ...
                        if(j==throughput.length-1) retVal[i]=0;
                    }
                }
            }
            return retVal;
    ...
    public double getGlobalX(){
        if(throughput==null) return Double.NaN;
        else{
            double retVal=0;
    ...
    public double getGlobalQ(){
        if(queueLen==null) return Double.NaN;
        else{
            double retVal=0;
        ...
        if(resTimes==null) return null;
            ...
            for(int i=0; i<retVal.length; i++){
                ...
                for(int j=0; j<resTimes[i].length; j++){
                    if(xClassAggs!=null) retVal[i] += xClassAggs[j]*resTimes[i][j];
                    else return null;
                }
                if(xGlobal!=0) retVal[i] /= xGlobal;
                else retVal[i] = 0;
            }
            return retVal;
        }
    ...
    public double getGlobalR(){
        if(resTimes==null) return Double.NaN;
        else{
            double retVal = 0;
    ...
    public double getGlobalU(){
        if(util==null) return Double.NaN;
        else{
            double retVal = 0;
