...
public class QQPlotPreviewPanel extends JPanel implements CommonConstants{
	...
	private void initGUI(){
		...
		ok.add(new JLabel(HTML_START + HTML_FONT_TITLE + "QQ-Plot" + HTML_FONT_TIT_END 
				+ HTML_FONT_NORM + "Actual quantile distribution<p>" +
								   "versus normal or exponential<p>" +
								   HTML_FONT_NOR_END + HTML_END),BorderLayout.CENTER);
