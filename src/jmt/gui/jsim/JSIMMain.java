...
public class JSIMMain extends Wizard implements GuiInterface{
    ...
    public boolean cancel(){
        if (checkForSave("<html>Save changes before closing?</html>")) return false;
        Dimension d = getSize();
    ...
    private void showHelp(){
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(this, "Sorry, jSIM help is not available",
    ...
    private JMTToolBar createToolBar(){
        ...
        AbstractJMTAction[] items = new AbstractJMTAction[]{
