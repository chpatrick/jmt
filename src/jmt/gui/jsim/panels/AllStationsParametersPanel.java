...
public class AllStationsParametersPanel extends WizardPanel implements CommonConstants {
    ...
    private void initComponents(){
        ...
        JScrollPane jsp = new JScrollPane(stationsList,
    ...
    public void showStationParameterPanel(Object stationKey,Object classKey,int index) {
        ...
        if (index == 0) stationParsPane.showQueueSectionPanel();
        else if (index == 1) stationParsPane.showServiceSectionPanel();
        else if (index == 2) stationParsPane.showRoutingSectionPanel(classKey);
    ...
    public void setData(StationDefinition sd, ClassDefinition cd){
        this.stationData = sd;
        this.classData = cd;
        if(stationParsPane != null)stationParsPane.setData(stationData, classData, null);
        repaint();
    }
    ...
    private class StationElementRenderer implements ListCellRenderer{
        ...
        public Component getListCellRendererComponent(
            ...
            JLabel label = new JLabel(stationData.getStationName(value),
                    JMTImageLoader.loadImage(stationData.getStationType(value)+"Combo"),
                    JLabel.LEFT);
