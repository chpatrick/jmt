...
public class JobInfoList {
	...
	private double LastJobOutTime, LastJobInTime, LastJobDropTime,
	LastJobOutTimePerClass[], LastJobInTimePerClass[], LastJobDropTimePerClass[];

	private Measure Utilization, UtilizationPerClass[],
	ResponseTime, ResponseTimePerClass[],
	ResidenceTime, ResidenceTimePerClass[],
    QueueLength, QueueLengthPerClass[], DropRate, DropRatePerClass[];
    //OLD
 ...
 *---------------------------------------------------------------------*/
	...
	public double getLastModifyTimePerClass(JobClass JobClass) {
		if (LastJobOutTimePerClass[JobClass.getId()] >=
		        LastJobInTimePerClass[JobClass.getId()] && LastJobOutTimePerClass[JobClass.getId()] >=
                LastJobDropTimePerClass[JobClass.getId()])
			return LastJobOutTimePerClass[JobClass.getId()];
		else if (LastJobInTimePerClass[JobClass.getId()] >=
                LastJobOutTimePerClass[JobClass.getId()] && LastJobInTimePerClass[JobClass.getId()] >=
                    LastJobDropTimePerClass[JobClass.getId()])
			return LastJobInTimePerClass[JobClass.getId()];
        else
            return LastJobDropTimePerClass[JobClass.getId()];
