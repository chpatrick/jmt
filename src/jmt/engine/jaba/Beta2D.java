...
public class Beta2D {
    ...
    public Vector StatAss(Vector sector)
    {
        ...
        {
            Sector2D sss = new Sector2D(0,1,((Sector2D)sector.get(0)).getBeta1(),
                    ((Sector2D)sector.get(0)).getBeta11(),
                    ((Sector2D)sector.get(0)).getP1());
            out.addElement(sss);
        }
        ...
        for (int i=0;i<(sector.size());i++)
        {
            ...
            Sector2D sss = new Sector2D(((Sector2D)sector.get(i)).getBeta1(),
                    ((Sector2D)sector.get(i)).getBeta11(),((Sector2D)sector.get(i)).getBeta2(),
                    ((Sector2D)sector.get(i)).getBeta22(),
                    ((Sector2D)sector.get(i)).getP1(),((Sector2D)sector.get(i)).getP2());
            out.addElement(sss);
            ...
            {
                Sector2D ss1=new Sector2D(
                              ((Sector2D)sector.get(i)).getBeta2(),
                              ((Sector2D)sector.get(i)).getBeta22(),
                              ((Sector2D)sector.get(i+1)).getBeta1(),
                              ((Sector2D)sector.get(i+1)).getBeta11(),
                              ((Sector2D)sector.get(i)).getP2()
                            );
                out.addElement(ss1);
            }
            ...
            {
                Sector2D ssf=new Sector2D(((Sector2D)sector.get(i)).getBeta2(),
                    ((Sector2D)sector.get(i)).getBeta22(),1,0,
                              ((Sector2D)sector.get(i)).getP2()); //aggiungere ,end
                out.addElement(ssf);
            }
