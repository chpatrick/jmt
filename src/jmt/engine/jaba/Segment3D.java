...
public class Segment3D {
    ...
    public Vector FixLtFromJoin(Vector sett2staz,Vector lt)
    {
        ...
        for (int j=0;j<lt.size();j++)
        {
            ...
            if (
                ((Sector3D)sett2staz.get(i)).getS0()==((Segment3D)lt.get(j)).getS1() &&
            ...
            lt.addElement(new Segment3D(
                    ((Sector3D)sett2staz.get(i)).getBeta(0,1),
                    ((Sector3D)sett2staz.get(i)).getBeta(0,2),
                    ((Sector3D)sett2staz.get(i)).getBeta(0,3),
                    ((Sector3D)sett2staz.get(i)).getBeta(1,1),
                    ((Sector3D)sett2staz.get(i)).getBeta(1,2),
                    ((Sector3D)sett2staz.get(i)).getBeta(1,3),
                    ((Sector3D)sett2staz.get(i)).getS0(),
                    ((Sector3D)sett2staz.get(i)).getS1()
            ));
            // Aggiungo il segmento fatto dalla seconda stazione che satura
            lt.addElement(new Segment3D(
                    ((Sector3D)sett2staz.get(i)).getBeta(2,1),
                    ((Sector3D)sett2staz.get(i)).getBeta(2,2),
                    ((Sector3D)sett2staz.get(i)).getBeta(2,3),
                    ((Sector3D)sett2staz.get(i)).getBeta(3,1),
                    ((Sector3D)sett2staz.get(i)).getBeta(3,2),
                    ((Sector3D)sett2staz.get(i)).getBeta(3,3),
                    ((Sector3D)sett2staz.get(i)).getS2(),
                    ((Sector3D)sett2staz.get(i)).getS(3)
            ));
        }
        return lt;
    }
    ...
    public Vector FixLtFrom2Dxy(Vector resxy)
    {
        ...
        for (int i=0; i<resxy.size();i++)
        {
            Vertex st1 = new Vertex(
                    ((newPoint)((Sector2D)resxy.get(i)).getP1()).x,
                    ((newPoint)((Sector2D)resxy.get(i)).getP1()).y,
            // metto -1 per indicare che la coordinata originale si è persa
                    -1
                    );
            Vertex st2 = new Vertex(
                    ((newPoint)((Sector2D)resxy.get(i)).getP2()).x,
                    ((newPoint)((Sector2D)resxy.get(i)).getP2()).y,
                    -1
                    );
            out.addElement(new Segment3D(
                ((Sector2D)resxy.get(i)).getBeta1(),
                ((Sector2D)resxy.get(i)).getBeta11(),
                // i punti che arrivano da xy hanno per definizione beta3=0
                0,
                ((Sector2D)resxy.get(i)).getBeta2(),
                ((Sector2D)resxy.get(i)).getBeta22(),
                0,
                st1,
                st2
            ));
    ...
    public Vector FixLtFrom2Dxz(Vector resxz)
    {
        ...
        {
            Vertex st1 = new Vertex(
                    ((newPoint)((Sector2D)resxz.get(i)).getP1()).x,
            // metto -1 per indicare che la coordinata originale si è persa
                    -1,
                    ((newPoint)((Sector2D)resxz.get(i)).getP1()).y
                    );
            Vertex st2 = new Vertex(
                    ((newPoint)((Sector2D)resxz.get(i)).getP2()).x,
                    -1,
                    ((newPoint)((Sector2D)resxz.get(i)).getP2()).y
                    );
            out.addElement(new Segment3D(
                ((Sector2D)resxz.get(i)).getBeta1(),
                // i punti che arrivano da xz hanno per definizione beta2=0
                0.0,
                ((Sector2D)resxz.get(i)).getBeta11(),
                ((Sector2D)resxz.get(i)).getBeta2(),
                0.0,
                ((Sector2D)resxz.get(i)).getBeta22(),
                st1,
                st2
            ));
        }
    ...
    public Vector FixLtFrom2Dyz(Vector resyz)
    {
        ...
        for (int i=0; i<resyz.size();i++)
        {
            Vertex st1 = new Vertex(
                    // metto -1 per indicare che la coordinata originale si è persa
                    -1,
                    ((newPoint)((Sector2D)resyz.get(i)).getP1()).x,
                    ((newPoint)((Sector2D)resyz.get(i)).getP1()).y
                    );
            Vertex st2 = new Vertex(
                    -1,
                    ((newPoint)((Sector2D)resyz.get(i)).getP2()).x,
                    ((newPoint)((Sector2D)resyz.get(i)).getP2()).y
                    );
            out.addElement(new Segment3D(
                // i punti che arrivano da yz hanno per definizione beta2=0
                0.0,
                ((Sector2D)resyz.get(i)).getBeta1(),
                ((Sector2D)resyz.get(i)).getBeta11(),
                0,
                ((Sector2D)resyz.get(i)).getBeta2(),                
                ((Sector2D)resyz.get(i)).getBeta22(),
                st1,
                st2
            ));
        }
