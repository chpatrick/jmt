            ...
            for (int j=0; j<oristations.size();j++){
                ...
                if (
                        (Math.abs(v1[0]-v2[0])<0.001 &&
                                Math.abs(v1[1]-v2[1])<0.001 &&
                                Math.abs(v1[2]-v2[2])<0.001) ||
                        (Math.abs(v1[0]-v2[0])<0.001 &&
                                Math.abs(v1[1]-v2[1])<0.001 &&
                                (v1[2]==-1 || v2[2]==-1)) ||
                        (Math.abs(v1[0]-v2[0])<0.001 &&
    ...
    public String toString(){
        String out = "";
        {
            ...
            for (int i=0;i<points.size();i++)
            {
                ...
                betas = betas.concat("<br>" +
                    classNames[0]+":  " +b1/1000+ "   "+classNames[1]+":  " +b2/1000+ "   "+classNames[2]+":  " +b3/1000);
            }
            out=
                    "<font size=\"4\">" +
                    "<b>"+
