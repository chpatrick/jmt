...
public class Constants {
	...
	* MAXLOG =  8.8029691931113054295988E1       getLog(2**127)
	* MINLOG = -8.872283911167299960540E1        getLog(2**-128)
	* MAXNUM =  1.701411834604692317316873e38    2**127
	*
	* For IEEE arithmetic (IBMPC):
	* MACHEP =  1.11022302462515654042E-16       2**-53
	* MAXLOG =  7.09782712893383996843E2         getLog(2**1024)
	* MINLOG = -7.08396418532264106224E2         getLog(2**-1022)
	...
	* LOG2E  =  1.4426950408889634073599         1/getLog(2)
	* SQ2OPI =  7.9788456080286535587989E-1      sqrt( 2/pi )
	* LOGE2  =  6.93147180559945309417E-1        getLog(2)
	* LOGSQ2 =  3.46573590279972654709E-1        getLog(2)/2
