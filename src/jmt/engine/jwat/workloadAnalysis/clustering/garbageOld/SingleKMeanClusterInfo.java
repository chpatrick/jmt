package jmt.engine.jwat.workloadAnalysis.clustering.garbageOld;
...
import jmt.engine.jwat.workloadAnalysis.chart.KMeanSingleClusterScatter;
	...
	private void initPanel(){
		...
		loadInfo.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e) {
				int ret=JOptionPane.showConfirmDialog(SingleKMeanClusterInfo.this,"This operation may require several minutes, continue? ","Warning!!",JOptionPane.YES_NO_OPTION,JOptionPane.WARNING_MESSAGE);
