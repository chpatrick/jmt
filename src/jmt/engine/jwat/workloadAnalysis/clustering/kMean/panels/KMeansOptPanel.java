...
public class KMeansOptPanel extends JPanel implements CommonConstants{
	...
	private void setSolveAction(){
		...
		((WorkloadAnalysisWizard)parent.getParentWizard()).setActionButton("Solve",new AbstractAction(){
		...
		((WorkloadAnalysisWizard)parent.getParentWizard()).setActionTool(new AbstractAction(){
			{
